		...
		<div id="bottomWrap">
			...
			<div id="company-info">
				...
				<p style="font-size: 0.7rem; width: 700px;">
					딜리벤져스는 통신판매중개자이며 통신판매의 당사자가 아닙니다. 따라서 상품/ 거래정보 및 거래와 관련하여  딜리벤져스에 등록된 판매자의 고의 또는 과실로 소비자에게 발생하는 손해에 대해 딜리벤져스는 책임을 지지 않습니다. 상품 및 거래에 관하여 보다 정확한 정보는 해당 판매자에게 직접 확인하여 주시기 바랍니다. Copyright Delivengers. All Rights Reserved.
				</p>
			</div>
			<div id="linkWrap">
				폰트 변경
